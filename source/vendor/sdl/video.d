...
@nogc extern (C)
{
    ...
    static uint SDL_WINDOWPOS_CENTERED_DISPLAY(uint X) => SDL_WINDOWPOS_CENTERED_MASK | (X);

    enum
    {
        SDL_WINDOWPOS_CENTERED_MASK = 0x2FFF0000u,
    ...
    SDL_Window* SDL_DestroyWindow(SDL_Window* window);
